...
<section class="banner-section style-three">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                ...
                <div class="content-outer">
                    <div class="content-box">
                        <div class="inner">
                            <h4>Baja Residences</h4>
                            <h1>Los Cabos <br>
                                el mejor lugar <br>
                                para vivir.</h1>
                            <div class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit <br> Turpis
                                ridiculus tellus.</div>
                            <div class="link-box">
                                <a href="/propiedades" class="btn-1">Ver más<span></span></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="swiper-slide">
                ...
                <div class="content-outer">
                    <div class="content-box">
                        <div class="inner">
                            <h4>¿Ya sabes en dónde invertir?</h4>
                            <h1>Baja <br> Residence</h1>
                            <div class="text">
                                La mejor opción de inversión  para tu nuevo hogar
                            </div>
                            <div class="link-box">
                                <a href="/propiedades" class="btn-1">Ver más<span></span></a>
                            </div>
    ...
    <div class="banner-slider-nav">
        ...
        <div class="banner-slider-control banner-slider-button-next hvr-zoom-1 hvr-zoom-1-primary"><span><i
                    class="icon-3"></i></span> </div>
    </div>
</section>

<div hidden class="hotel-booking-form-1 gray-bg">
        ...
        <div class="hotel-booking-form-1-wrap">
            <form class="hotel-booking-form-1-form flex-grow-1 d-flex align-items-end">
                <div class="form-group">
                    ...
                    <input placeholder="17 Sep, 2022" class="" type="text" name="form-name"
                        id="nd_booking_archive_form_date_range_from" value="" />
                </div>
                <div class="form-group">
                    <p class="hotel-booking-form-1-label text-lg-center">Check - Out:</p>
                    <input placeholder="21 Sep, 2022" class="" type="text" name="form-name"
...
<section class="section-padding">
    ...
    <div class="auto-container">
        <div class="section_heading text-center mb_60">
            <span class="section_heading_title_small">Nuestros desarrollos</span>
            <h2 class="section_heading_title_big">Encuentra tu  <br>casa ideal</h2>
        </div>
        <div class="row">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 ps-lg-5">
                ...
                <div class="about-1-btn mb_30">
                    <a href="/contacto" class="btn-1">Contactar<span></span></a>
                </div>
            </div>
        </div>
    </div>
...
<section class="section-padding">
    <div class="auto-container">
        <div class="section_heading text-center mb_55">
            <span class="section_heading_title_small">Descubre</span>
            <h2 class="section_heading_title_big">Nuestros mejores desarrollos</h2>
        </div>
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="room-1-block wow fadeInUp" data-wow-delay=".2s" data-wow-duration=".8s">
                    ...
                    <div class="room-1-content">
                        ...
                        <h4 class="room-1-title mb_20"><a href="/contacto">Desarrollo 1</a></h4>
                        <p class="room-1-text mb_30">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet, eaque?
                        </p>
                        <div class="link-btn"><a href="/contacto" class="btn-1 btn-alt">Contactar<span></span></a></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="room-1-block wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.2s">
                    ...
                    <div class="room-1-content">
                        ...
                        <h4 class="room-1-title mb_20"><a href="room-details.html">Desarrollo 2</a></h4>
                        <p class="room-1-text mb_30">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="room-1-block wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.5s">
                    ...
                    <p class="room-1-meta-info"> <span class="theme-color">180 m2</span></p>
                        ...
                        <h4 class="room-1-title mb_20"><a href="room-details.html">Desarrollo 3</a></h4>
                        <p class="room-1-text mb_30">
        ...
        <div class="project-1-wrapper">
            <div class="swiper-container single-item-carousel">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="project-1-image"
                            style="background-image: url(assets/images/resource/project-1.jpg);">
                            <div class="project-1-block">
                                <span class="section_heading_title_small">San José del Cabo</span>
                                <h2 class="section_heading_title_big fs_50 mb_20">Las mejores ubicaciones</h2>
                    ...
                    <div class="swiper-slide">
                        <div class="project-1-image"
                            style="background-image: url(assets/images/resource/project-2.jpg);">
                            <div class="project-1-block">
                                <span class="section_heading_title_small">Corredor Turístico</span>
                                <h2 class="section_heading_title_big fs_50 mb_20">Encuentra el ideal</h2>
                                <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit
                                    Adipiscing integer ultrices suspendisse varius etiam est
                                    tempus nec vitae orci sodales.</p>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="project-1-image"
                            style="background-image: url(assets/images/resource/project-3.jpg);">
                            <div class="project-1-block">
                                <span class="section_heading_title_small">Cabo San Lucas</span>
                                <h2 class="section_heading_title_big fs_50 mb_20">Lo más destacado</h2>
                                <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit
                                    Adipiscing integer ultrices suspendisse varius etiam est
                                    tempus nec vitae orci sodales.</p>
                            </div>
                ...
                <div class="slider-nav-style-1 project-1-nav">
                    <div class="slider-control slider-button-prev hvr-zoom-1 hvr-zoom-1-primary"><span><i
                                class="icon-3"></i></span></div>
                    <div class="slider-control slider-button-next hvr-zoom-1 hvr-zoom-1-primary"><span><i
                                class="icon-2"></i></span> </div>
                </div>
            </div>
        </div>
    ...
    <div class="auto-container">
        <div class="team-1-wrapper">
            <div class="section_heading text-center mb_50">
                <span class="section_heading_title_small">En Baja Residence nos ocupamos de todo</span>
                <h2 class="section_heading_title_big mb_20">Nuestras amenidades</h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Adipiscing integer ultrices suspendisse
                    varius etiam est. <br> Est, felis, tempus nec vitae orci sodales Metus, velit nec at diam in sed.
                    Massa dui ipsum ornare sagittis dolor <br> sagittis amet odio est. Sit semper et velit fusce.</p>
            </div>
            <div class="row">
...
<section class="section-padding">
    <div class="auto-container">
        <div class="row">
            <div class="col-lg-4">
                <div class="section_heading mb_20">
                    <span class="section_heading_title_small">Opiniones</span>
                    <h2 class="section_heading_title_big">¿Qué <br> Dicen <br> Nuestros clientes?</h2>
                </div>
                <p class="testimonial-1-desc">Amet dui scelerisque vel habitant eget <br> tincidunt facilisis pretium.
                    Porttitor mi <br> nisi, non vitae tempus.</p>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-1-block">
                                    ...
                                    <p class="testimonial-1-review-desc">
                                        "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi, perferendis quam ullam consequuntur sint laborum minus iusto, saepe et atque excepturi quisquam ex! Harum magnam illo sed doloribus quisquam delectus?"
                                    </p>
                                    <h4 class="testimonial-1-name">Cliente 1</h4>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-1-block">
                                    ...
                                    <h4 class="testimonial-1-name">Cliente 2</h4>
                                    <!-- <p class="testimonial-1-designation">Manager</p> -->
                                    <div class="testimonial-1-author-thumb">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-1-block">
                                    ...
                                    <h4 class="testimonial-1-name">Cliente 3</h4>
                                    <!-- <p class="testimonial-1-designation">Manager</p> -->
                                    <div class="testimonial-1-author-thumb">
                                        <img src="assets/images/resource/testimonial-2.jpg" alt="">
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-1-block">
                                    ...
                                    <h4 class="testimonial-1-name">Cliente 4</h4>
                                    <!-- <p class="testimonial-1-designation">Manager</p> -->
                                    <div class="testimonial-1-author-thumb">
                                        <img src="assets/images/resource/testimonial-2.jpg" alt="">
                                    </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="blog-1-block wow fadeInLeft" data-wow-delay=".2s" data-wow-duration=".8s">
                    ...
                    <div class="blog-1-bottom-content">
                        ...
                        <div class="blog-1-link-btn"><a href="blog-details.html"
                                class="h_50 w_50 hvr-zoom-1 circle-btn lh_50 fs_13 hvr-zoom-1-primary"><i
                                    class="icon-5"></i></a></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInLeft" data-wow-delay=".2s" data-wow-duration=".8s">
                <div class="blog-1-block">
                    ...
                    <div class="blog-1-bottom-content">
                        <div class="blog-1-date">15 APRIL</div>
                        <h4 class="blog-1-title"><a href="blog-details.html">How to book a Resort in best price on
                                Mountains</a></h4>
                        <ul class="d-flex blog-1-meta-info">
                            <li>Admin</li>
                            <li>0 Comment</li>
