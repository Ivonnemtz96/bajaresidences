            ...
            <div class="col-lg-4 col-md-6">
                <div class="room-1-block wow fadeInUp" data-wow-delay=".2s" data-wow-duration=".8s">
                    ...
                    <div class="room-1-content">
                        ...
                        <p class="room-1-text mb_30">Mattis cras magna morb punar aenean aliquet in. Risus a arcu eget.
                        </p>
                        <div class="link-btn"><a href="room-details.html" class="btn-1 btn-alt">Book Now
                                <span></span></a></div>
                    </div>
                </div>
            </div>
...
<section class="cta-1-section">
    ...
    <div class="auto-container">
        ...
        <div class="text-center">
            <div class="cta-1-link-bt"><a href="javascript:void(0);" class="btn-1">Check Availability<span></span></a>
            </div>
        </div>
    </div>
</section>
